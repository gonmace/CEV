    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archivo', models.FileField(blank=True, null=True, upload_to=proyectos.models.especificacion_upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('imagen', models.ImageField(upload_to=proyectos.models.especificacion_imagen_upload_path)),
                ('descripcion', models.TextField(blank=True, verbose_name='Descripción')),
                ('fecha_subida', models.DateTimeField(auto_now_add=True)),
                ('especificacion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='imagenes', to='proyectos.especificacion')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='proyecto',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='especificaciones', to='proyectos.proyecto'),
        ),
    ]
