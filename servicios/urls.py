...
urlpatterns = [
    ...
    path('<int:servicio_id>/alcance/secciones/', views.generar_secciones_ajax, name='generar_secciones_ajax'),
    path('<int:servicio_id>/secciones/', views.paso4_secciones_view, name='paso4_secciones'),
    path('<int:servicio_id>/consolidar/', views.paso5_consolidar_view, name='paso5_consolidar'),
    ...
    path('<int:servicio_id>/toggle-publico/', views.toggle_publico_view, name='toggle_publico'),
    path('<int:servicio_id>/exportar-word/', views.exportar_servicio_word_view, name='exportar_word'),
    ...
    path('<int:servicio_id>/guardar-contenido/', views.guardar_contenido_ajax, name='guardar_contenido'),
